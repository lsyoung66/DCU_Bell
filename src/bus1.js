          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>1호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경상고등학교' })}>
                    <Text style={styles.txt}>경상고등학교</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '신한은행 복현지점(복현오거리)' })}>
                    <Text style={styles.txt}>신한은행 복현지점(복현오거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '산격대우아파트' })}>
                    <Text style={styles.txt}>산격대우아파트</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '강북지구대' })}>
                    <Text style={styles.txt}>강북지구대</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '홈플러스 칠곡점' })}>
                    <Text style={styles.txt}>홈플러스 칠곡점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '칠곡초등학교' })}>
                    <Text style={styles.txt}>칠곡초등학교</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

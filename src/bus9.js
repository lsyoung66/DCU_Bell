          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>9호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '반야월주유소(S-OIL)' })}>
                    <Text style={styles.txt}>반야월주유소(S-OIL)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '우방강촌마을' })}>
                    <Text style={styles.txt}>우방강촌마을</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대동병원' })}>
                    <Text style={styles.txt}>대동병원</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '(구)동부정류장' })}>
                    <Text style={styles.txt}>(구)동부정류장</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '바로본병원(동신교)' })}>
                    <Text style={styles.txt}>바로본병원(동신교)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '중구청' })}>
                    <Text style={styles.txt}>중구청</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대구콘서트하우스' })}>
                    <Text style={styles.txt}>대구콘서트하우스</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '전진욱 정형외과(북비산네거리)' })}>
                    <Text style={styles.txt}>전진욱 정형외과(북비산네거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '서부중학교' })}>
                    <Text style={styles.txt}>서부중학교</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

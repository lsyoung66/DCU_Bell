          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>5호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '신천주유소(GS)' })}>
                    <Text style={styles.txt}>신천주유소(GS)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '수성시장 버스정류장' })}>
                    <Text style={styles.txt}>수성시장 버스정류장</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '명덕역' })}>
                    <Text style={styles.txt}>명덕역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '현대자동차 남대구점(계명네거리)' })}>
                    <Text style={styles.txt}>현대자동차 남대구점(계명네거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '채움주유소(SK)' })}>
                    <Text style={styles.txt}>채움주유소(SK)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대구은행 삼익뉴타운지점 건너편' })}>
                    <Text style={styles.txt}>대구은행 삼익뉴타운지점 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '중리롯데캐슬' })}>
                    <Text style={styles.txt}>중리롯데캐슬</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '투썸플레이스(신평리네거리)' })}>
                    <Text style={styles.txt}>투썸플레이스(신평리네거리)</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

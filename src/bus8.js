          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>8호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  ...
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '용산역' })}>
                    <Text style={styles.txt}>용산역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '월성초등학교' })}>
                    <Text style={styles.txt}>월성초등학교</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '청구코아' })}>
                    <Text style={styles.txt}>청구코아</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '월서초등학교' })}>
                    <Text style={styles.txt}>월서초등학교</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '상인초등학교' })}>
                    <Text style={styles.txt}>상인초등학교</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

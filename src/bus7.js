          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>7호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경산IC(경유)' })}>
                    <Text style={styles.txt}>경산IC(경유)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '성서IC(경유)' })}>
                    <Text style={styles.txt}>성서IC(경유)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대우월드마크웨스트엔드(죽전네거리)' })}>
                    <Text style={styles.txt}>대우월드마크웨스트엔드(죽전네거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '본동복어' })}>
                    <Text style={styles.txt}>본동복어</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '그린맨션' })}>
                    <Text style={styles.txt}>그린맨션</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '나라신경외과' })}>
                    <Text style={styles.txt}>나라신경외과</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '상원고등학교' })}>
                    <Text style={styles.txt}>상원고등학교</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

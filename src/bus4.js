          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>4호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '홈플러스 동촌점' })}>
                    <Text style={styles.txt}>홈플러스 동촌점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '라온치과(복현오거리)' })}>
                    <Text style={styles.txt}>라온치과(복현오거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '명성푸르지오' })}>
                    <Text style={styles.txt}>명성푸르지오</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '이마트 칠성점' })}>
                    <Text style={styles.txt}>이마트 칠성점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '노원동 우체국' })}>
                    <Text style={styles.txt}>노원동 우체국</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '북부정류장' })}>
                    <Text style={styles.txt}>북부정류장</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>11호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  ...
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '율하역' })}>
                    <Text style={styles.txt}>율하역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '용지역' })}>
                    <Text style={styles.txt}>용지역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '수성동아백화점' })}>
                    <Text style={styles.txt}>수성동아백화점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '동아스포츠센터 건너편' })}>
                    <Text style={styles.txt}>동아스포츠센터 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '수성못오거리' })}>
                    <Text style={styles.txt}>수성못오거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '수성동일하이빌 후문' })}>
                    <Text style={styles.txt}>수성동일하이빌 후문</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>13호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '진량 굿모닝주유소(현대)' })}>
                    <Text style={styles.txt}>진량 굿모닝주유소(현대)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경산IC 입구' })}>
                    <Text style={styles.txt}>경산IC 입구</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '영남대학교 건너편' })}>
                    <Text style={styles.txt}>영남대학교 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경산시장' })}>
                    <Text style={styles.txt}>경산시장</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경산역' })}>
                    <Text style={styles.txt}>경산역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '옥산네거리' })}>
                    <Text style={styles.txt}>옥산네거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '사월역' })}>
                    <Text style={styles.txt}>사월역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '농협 시지지점' })}>
                    <Text style={styles.txt}>농협 시지지점</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

...
export default class ComeScreen extends Component {
  state = {
  ...
  goBus3() {
    this.props.navigation.navigate('B3');
  }
  goBus4() {
    this.props.navigation.navigate('B4');
  }
  goBus5() {
    this.props.navigation.navigate('B5');
  }
  goBus6() {
    this.props.navigation.navigate('B6');
  }
  goBus7() {
    this.props.navigation.navigate('B7');
  }
  goBus8() {
    this.props.navigation.navigate('B8');
  }
  goBus9() {
    this.props.navigation.navigate('B9');
  }
  goBus10() {
    this.props.navigation.navigate('B10');
  }
  goBus11() {
    this.props.navigation.navigate('B11');
  }
  goBus12() {
    this.props.navigation.navigate('B12');
  }
  goBus13() {
    this.props.navigation.navigate('B13');
  }
  goBus14() {
    this.props.navigation.navigate('B14');
  }
  goBus15() {
    this.props.navigation.navigate('B15');
  }
  goBus_night() {
    this.props.navigation.navigate('B16');
  }
  ...
  pressAnsim(){
    this.setState({ isModalVisible: true, bus: '안심역' });
    this.componentDidMount();
  }

  pressSawol(){
    this.setState({ isModalVisible: true, bus: '사월역' });
    this.componentDidMount();
  }
            ...
            <>
              <View>
                <View style={styles.header}>
                  ...
                  <Text style={styles.header_text}>하교</Text>
                  <Image
                ...
                <ScrollView>
                  <Text style={styles.title}>지하철</Text>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.pressAnsim()}>
                    <Text style={styles.txt}>안심역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.pressSawol()}>
                    <Text style={styles.txt}>사월역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus_night()}>
                    <Text style={styles.txt}>야간 (22:00)</Text>
                  </TouchableOpacity>
                  <Text style={styles.title}>시내</Text>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus1()}>
                    <Text style={styles.txt}>1호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus2()}>
                    <Text style={styles.txt}>2호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus3()}>
                    <Text style={styles.txt}>3호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus4()}>
                    <Text style={styles.txt}>4호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus5()}>
                    <Text style={styles.txt}>5호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus6()}>
                    <Text style={styles.txt}>6호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus7()}>
                    <Text style={styles.txt}>7호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus8()}>
                    <Text style={styles.txt}>8호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus9()}>
                    <Text style={styles.txt}>9호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus10()}>
                    <Text style={styles.txt}>10호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus11()}>
                    <Text style={styles.txt}>11호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus12()}>
                    <Text style={styles.txt}>12호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus13()}>
                    <Text style={styles.txt}>13호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus14()}>
                    <Text style={styles.txt}>14호차</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayLongPress={270} onLongPress={() => this.goBus15()}>
                    <Text style={styles.txt}>15호차</Text>
                  </TouchableOpacity>
                  <Text></Text>
                  <Text></Text>
                  <Text></Text>

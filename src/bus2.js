          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>2호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '다이소 대구동서변점 건너편 (동서변네거리)' })}>
                    <Text style={styles.txt}>다이소 대구동서변점 건너편 (동서변네거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대구은행 학정로지점 건너편' })}>
                    <Text style={styles.txt}>대구은행 학정로지점 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '화성센트럴아파트 209동' })}>
                    <Text style={styles.txt}>화성센트럴아파트 209동</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '동천지구대' })}>
                    <Text style={styles.txt}>동천지구대</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>10호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대륜고 건너편' })}>
                    <Text style={styles.txt}>대륜고 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '학문당입시학원' })}>
                    <Text style={styles.txt}>학문당입시학원</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대구은행 범어동지점' })}>
                    <Text style={styles.txt}>대구은행 범어동지점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '반월당역 10번출구' })}>
                    <Text style={styles.txt}>반월당역 10번출구</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대신센트럴자이(중부소방서)' })}>
                    <Text style={styles.txt}>대신센트럴자이(중부소방서)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '구병원 건너편' })}>
                    <Text style={styles.txt}>구병원 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '성서보람타운' })}>
                    <Text style={styles.txt}>성서보람타운</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '성서산업단지역' })}>
                    <Text style={styles.txt}>성서산업단지역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '계명대 정문' })}>
                    <Text style={styles.txt}>계명대 정문</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>3호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '동촌농협 방촌지점' })}>
                    <Text style={styles.txt}>동촌농협 방촌지점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '입석초등학교 건너편' })}>
                    <Text style={styles.txt}>입석초등학교 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '동구청' })}>
                    <Text style={styles.txt}>동구청</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '복현네거리' })}>
                    <Text style={styles.txt}>복현네거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대백인터빌아파트(팔달교)' })}>
                    <Text style={styles.txt}>대백인터빌아파트(팔달교)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '타이어뱅크 칠곡점(태전네거리)' })}>
                    <Text style={styles.txt}>타이어뱅크 칠곡점(태전네거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '티월드 칠곡점(태전삼거리)' })}>
                    <Text style={styles.txt}>티월드 칠곡점(태전삼거리)</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '경북약국' })}>
                    <Text style={styles.txt}>경북약국</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

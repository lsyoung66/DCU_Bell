...
import {
  ...
  ScrollView, Image, Alert, SafeAreaView, ImageBackground
} from "react-native";
          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>6호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '만촌네거리' })}>
                    <Text style={styles.txt}>만촌네거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '가든하이츠3단지' })}>
                    <Text style={styles.txt}>가든하이츠3단지</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대구은행 황금동지점' })}>
                    <Text style={styles.txt}>대구은행 황금동지점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '농협 중동지점' })}>
                    <Text style={styles.txt}>농협 중동지점</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '이조왕갈비' })}>
                    <Text style={styles.txt}>이조왕갈비</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '팔레스호텔' })}>
                    <Text style={styles.txt}>팔레스호텔</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '영대병원네거리' })}>
                    <Text style={styles.txt}>영대병원네거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '현충로역' })}>
                    <Text style={styles.txt}>현충로역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '안지랑네거리' })}>
                    <Text style={styles.txt}>안지랑네거리</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '성당못역' })}>
                    <Text style={styles.txt}>성당못역</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

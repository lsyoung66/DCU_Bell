          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>14호차</Text>
                <Image
              ...
              <ScrollView>
                <View style={{ marginTop: '5%' }}>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '대평주공그린빌아파트' })}>
                    <Text style={styles.txt}>대평주공그린빌아파트</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '정평역' })}>
                    <Text style={styles.txt}>정평역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '사월역' })}>
                    <Text style={styles.txt}>사월역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '파티마 여성병원' })}>
                    <Text style={styles.txt}>파티마 여성병원</Text>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '수성구청역' })}>
                    <Text style={styles.txt}>수성구청역</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '그랜드호텔' })}>
                    <Text style={styles.txt}>그랜드호텔</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: '어린이회관 건너편' })}>
                    <Text style={styles.txt}>어린이회관 건너편</Text>
                  </TouchableOpacity>
                  <TouchableOpacity delayPressOut={370} onPressOut={() => this.setState({ isModalVisible: true, bus: 'TBC' })}>
                    <Text style={styles.txt}>TBC</Text>
                  </TouchableOpacity>
                </View>
              </ScrollView>

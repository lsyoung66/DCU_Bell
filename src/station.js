...
import Sawol from './Sawol';
import Ansim from './Ansim';
...
export default class SubwayStation extends React.Component {
  state = {
    button1: 5, button2: 0,
  };
          ...
          <ImageBackground style={styles.background} source={background}>
            <>
              <View style={styles.header}>
                ...
                <Text style={styles.header_text}>지하철역</Text>
                <Image
              ...
              <View style={styles.Tab}>
                <View style={[styles.TabButton, { borderBottomWidth: this.state.button1 }]}>
                  <TouchableOpacity onPressIn={() => this.button1()} onPress={() => this.changeMenu(0)}>
                    <Text style={[styles.TabText]}>사월역</Text>
                  </TouchableOpacity>
                </View>
                <View style={[styles.TabButton, { borderBottomWidth: this.state.button2 }]}>
                  <TouchableOpacity onPressIn={() => this.button2()} onPress={() => this.changeMenu(1)}>
                    <Text style={[styles.TabText]}>안심역</Text>
                  </TouchableOpacity>
                </View>
              </View>
